...
// import THREE from 'aframe/src/lib/three';
import utils from 'aframe/src/utils/';
var bind = utils.bind;
...
function registerCustomLookControl() {
    ...
    AFRAME.registerComponent('custom-look-controls', {
        ...
        updateOrientation: (function () {
            ...
            return function () {
                ...
                object3D.rotation.x = this.magicWindowDeltaEuler.x * this.data.speedRateForPhone + pitchObject.rotation.x;
                object3D.rotation.y = this.magicWindowDeltaEuler.y * this.data.speedRateForPhone + yawObject.rotation.y;
                object3D.rotation.z = this.magicWindowDeltaEuler.z * this.data.speedRateForPhone ;
            };
        })(),
        ...
        onTouchMove: function (evt) {
            ...
            deltaP = 2 * Math.PI * (evt.touches[0].pageY - this.touchStart.y) / canvas.clientHeight;

            direction = this.data.reverseTouchDrag ? 1 : -1;
            // Limit touch orientaion to to yaw (y axis).
            yawObject.rotation.y -= deltaY * 0.5 * direction;
            pitchObject.rotation.x -= deltaP * 0.5 * direction;
            this.touchStart = {
                x: evt.touches[0].pageX,
                y: evt.touches[0].pageY
            };
...
export default registerCustomLookControl;